...
**A faithful Visual Studio Code port of the beautiful [koda.nvim](https://github.com/oskarnurm/koda.nvim) theme.**
...
- Dark minimal UI
- Koda.nvim inspired syntax colors
- Semantic highlighting support
- VS Code workbench customization
